...
public class bananasFoster1 extends JLayeredPane implements MouseListener,ActionListener
{
    ...
    public bananasFoster1(BFFrame fr) 
    {
        ...
        ImageIcon panIMG = new ImageIcon("assets/pan1.png");
        pan = new JLabel();
        pan.setIcon(panIMG);
        pan.setBounds(400, 100,522,450);
        panimgs = new ArrayList<ImageIcon>();
        panimgs.add(new ImageIcon("assets/pan2.png"));
        panimgs.add(new ImageIcon("assets/pan3.png"));
        panimgs.add(new ImageIcon("assets/pan4.png"));
        
        ImageIcon butterIMG = new ImageIcon("assets/butterbowl.png");
        ImageIcon sugarIMG = new ImageIcon("assets/sugarbowl.png");
        ImageIcon bananaIMG = new ImageIcon("assets/bananabowl.png");
        ...
        ImageIcon plateIMG = new ImageIcon("assets/pancake1.png");
        ...
        plateimgs.add(new ImageIcon("assets/pancake2.png"));
        plateimgs.add(new ImageIcon("assets/pancake3.png"));
        plateimgs.add(new ImageIcon("assets/pancake4.png"));
        
        ImageIcon syrupIMG = new ImageIcon("assets/syrup.png");
        ImageIcon whippedcreamIMG = new ImageIcon("assets/whippedcream.png");
        ImageIcon chocIMG = new ImageIcon("assets/chocolatechips.png");
