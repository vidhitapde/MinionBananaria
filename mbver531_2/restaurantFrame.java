...
public class restaurantFrame extends JFrame implements ActionListener
{
    ...
    public restaurantFrame(introFrame frame){
        ...
        ImageIcon orderIMG = new ImageIcon(getClass().getResource(myRestaurant.getMyOrder().getFoodName()));
    ...
    public void addOrder(){
        ...
        ImageIcon orderIMG = new ImageIcon(getClass().getResource(foodName));
        minionOrder.setIcon(orderIMG);
    ...
    public void checkForDone(){
        if(myRestaurant.getOrderNum() == myRestaurant.getOrderLength()){
            restaurantLayers.remove(orderButton);
            restaurantLayers.add(finishButton);
            restaurantLayers.moveToFront(finishButton);
            restaurantLayers.remove(minionOrder);
