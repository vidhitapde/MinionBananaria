...
public class bananaSmoothie1 extends JLayeredPane implements ActionListener//, MouseListener
{
    ...
    */
    ...
    bananaSmoothie1(kitchenFrame fr){
        ...
        ImageIcon introIMG = new ImageIcon("assets/intructionButton.png");
        ...
        introButton.setBounds(450,450,350,350);
        introButton.addActionListener(this);
        introButton.setIcon(introIMG);
        introButton.setBackground(new Color(0xFFFFFF));
    ...
    public void actionPerformed(ActionEvent event){
        ...
        if(event.getSource() == introButton){
